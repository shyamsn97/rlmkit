...
def test_workspace_fork_carries_flat_runtime_tree(tmp_path: Path):
    ...
    source_workspace.context.write_context("note", "context stays in context store")
    ...
    assert fork_workspace.context.read_context("note") == "context stays in context store"
